    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <button id="btnSubmitEmployeeRecord" type="button" class="btn btn-success navbar-right" onclick="ValidateAndSubmitAddEmployForm(); return false;">Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="dvResetEmployeeTableModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <button id="btnResetEmployeeTableSubmit" type="button" class="btn btn-danger navbar-right" onclick="resetEmployeeTable(); return false;">Yes</button>
                </div>
            </div>
        </div>
    </div>
